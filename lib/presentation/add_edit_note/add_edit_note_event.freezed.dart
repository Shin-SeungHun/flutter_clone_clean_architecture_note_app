...
class _$ChangeColorImpl<T> implements ChangeColor<T> {
...
abstract class ChangeColor<T> implements AddEditNoteEvent<T> {
  const factory ChangeColor({required final int color}) = _$ChangeColorImpl<T>;
...
class _$SaveNoteImpl<T> implements SaveNote<T> {
  const _$SaveNoteImpl(this.id, {required this.title, required this.content});
...
abstract class SaveNote<T> implements AddEditNoteEvent<T> {
  const factory SaveNote(final int? id,
      {required final String title,
      required final String content}) = _$SaveNoteImpl<T>;
