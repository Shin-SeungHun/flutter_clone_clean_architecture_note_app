...
class _$NoteOrderTitleImpl implements NoteOrderTitle {
  const _$NoteOrderTitleImpl({required this.orderType});
...
abstract class NoteOrderTitle implements NoteOrder {
  const factory NoteOrderTitle({required final OrderType orderType}) =
...
class _$NoteOrderDateImpl implements NoteOrderDate {
  const _$NoteOrderDateImpl({required this.orderType});
...
abstract class NoteOrderDate implements NoteOrder {
  const factory NoteOrderDate({required final OrderType orderType}) =
      _$NoteOrderDateImpl;
...
class _$NoteOrderColorImpl implements NoteOrderColor {
  const _$NoteOrderColorImpl({required this.orderType});
...
abstract class NoteOrderColor implements NoteOrder {
  const factory NoteOrderColor({required final OrderType orderType}) =
