...
// in flutter_clone_clean_architecture_note_app/test/domain/use_case/get_notes_use_case_test.dart.
...
class MockNoteRepository extends _i1.Mock implements _i2.NoteRepository {
  ...
  @override
  _i3.Future<_i4.Note?> getNoteById({required int? id}) => (super.noSuchMethod(
        Invocation.method(
          #getNoteById,
          [],
          {#id: id},
  ...
  @override
  _i3.Future<void> insertNote({required _i4.Note? note}) => (super.noSuchMethod(
        Invocation.method(
          #insertNote,
          [],
          {#note: note},
  ...
  @override
  _i3.Future<void> updateNote({required _i4.Note? note}) => (super.noSuchMethod(
        Invocation.method(
          #updateNote,
          [],
          {#note: note},
  ...
  @override
  _i3.Future<void> deleteNote({required _i4.Note? note}) => (super.noSuchMethod(
        Invocation.method(
          #deleteNote,
          [],
          {#note: note},
